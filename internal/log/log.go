...
func (l *Logger) newRecord(ctx context.Context, level slog.Level, msg string, attr ...any) slog.Record {
	...
	if level == slog.LevelError {
		r.Add("stacktrace", "\n"+string(zdebug.Stack(
			...
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.Delay",
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.NoStore",
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.RealIP",
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.Unpanic",
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.Wrap",
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.WrapWriter",
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.addcsp",
			"github.com/marvinrabe/goatcounter/handlers.backend.Mount.addctx",
			"github.com/marvinrabe/goatcounter/handlers.init.Add",
			"github.com/marvinrabe/goatcounter/handlers.init.Filter",
			"github.com/marvinrabe/goatcounter/internal/log.(*Logger).newRecord",
			"github.com/marvinrabe/goatcounter/internal/log.(*Logger).do",
			"github.com/marvinrabe/goatcounter/internal/log.Error",
			"github.com/marvinrabe/goatcounter/internal/log.Test",
	...
	r.Add(l.attr...)
	r.Add(attr...)
	if l.module != "" { // Removed with ReplaceAttr when creating the log handler.
