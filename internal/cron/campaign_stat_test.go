...
func TestCampaignStats(t *testing.T) {
	...
	testenv.StoreHits(ctx, t, false, []goatcounter.Hit{
		{CreatedAt: now, Path: "/?utm_campaign=one", FirstVisit: true},
		{CreatedAt: now, Path: "/?utm_campaign=one"},
		{CreatedAt: now, Path: "/?utm_campaign=two"},
		{CreatedAt: now, Path: "/?utm_campaign=three", FirstVisit: true},
	}...)
